...
* `SriLanka_Layers.zip` → A compressed archive containing all downloaded layers for offline use.
* Individual files in formats such as **GeoJSON, JSON, PBF**, depending on what the service provides.
